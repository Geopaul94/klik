...
class _ScreenEditProfileState extends State<ScreenEditProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: editProfileDetails(context, height, width, media),
  ...
  AppBar editProfileDetails(
      BuildContext context, double height, double width, Size media) {
    return AppBar(
      title: Row(
          ...
          BlocBuilder<EditUserProfileBloc, EditUserProfileState>(
            builder: (context, state) {
              if (state is EditUserProfileLoadingState ||
                  state is LoginUserDetailsDataFetchLoadingState) {
